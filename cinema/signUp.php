...
<?php
	...
	if(isset($_POST['Submit'])) {
		...
		$result = mysqli_query($mysqli, "INSERT INTO member(m_name,m_email,m_password,m_dob,m_gender,m_number,m_address, m_points) 
		VALUES('$name','$email','$password','$dob','$gender','$mobileNumber','$address', '0')");
